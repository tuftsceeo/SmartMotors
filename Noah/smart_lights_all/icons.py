...
fb_brightness = framebuf.FrameBuffer(bytearray(25*25), 25, 25, framebuf.MONO_HLSB)
fb_brightness.text('brightness', 0, 0)
fb_number = framebuf.FrameBuffer(bytearray(25*25), 25, 25, framebuf.MONO_HLSB)
fb_number.text('number', 0, 0)
fb_color = framebuf.FrameBuffer(bytearray(25*25), 25, 25, framebuf.MONO_HLSB)
fb_color.text('color', 0, 0)
...
iconFrames=[[fb_Train,fb_Play],[fb_smallplay,fb_color,fb_brightness,fb_number,fb_delete],[fb_next,fb_delete,fb_home]]
...
class SSD1306_SMART(ssd1306.SSD1306_I2C):
    ...
    def set_output_range(self, output_range):
        self.ranges['motor'] = output_range
